...
const getArticleContent = (_a) => __awaiter$1(void 0, [_a], void 0, function* ({ articles, browser, filterWords, logger }) {
    try {
...
const extractArticleContentAndFavicon = (_a) => __awaiter$1(void 0, [_a], void 0, function* ({ article, browser, filterWords, logger }) {
    var _b;
    try {
        ...
        const dom = new jsdom.JSDOM(content, { url: article.link, virtualConsole });
        let reader = new readabilityExports.Readability(dom.window.document);
